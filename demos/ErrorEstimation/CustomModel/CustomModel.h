...
// We will be using this to override the virtual function in the FPErrorEstimationModel
// class.
class CustomModel : public clad::FPErrorEstimationModel {
public:
  CustomModel(clad::DerivativeBuilder& builder) : FPErrorEstimationModel(builder) {}
