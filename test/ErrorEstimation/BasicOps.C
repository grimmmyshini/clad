...
// CHECK-NEXT:         _result[0UL] -= _r_d0;
// CHECK-NEXT:     }
// CHECK-NEXT:     _final_error += _delta_x + _delta_z + _delta_y;
// CHECK-NEXT: }
...
// CHECK-NEXT:         _result[0UL] -= _r_d0;
// CHECK-NEXT:     }
// CHECK-NEXT:     _final_error += _delta_z + _delta_x;
// CHECK-NEXT: }
...
// CHECK-NEXT:         _result[0UL] -= _r_d0;
// CHECK-NEXT:     }
// CHECK-NEXT:     _final_error += _delta_t + _delta_x + _delta_y + _delta_z;
// CHECK-NEXT: }
