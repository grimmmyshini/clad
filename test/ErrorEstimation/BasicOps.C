...
// CHECK-NEXT:         _result[1UL] += _r_d1;
// CHECK-NEXT:         _delta_y += _result[1UL] * _EERepl_y1 * {{.+}};
// CHECK-NEXT:         _result[1UL] += _r_d1;
...
// CHECK: void helper2_grad(float &x, double *_result) {
// CHECK-NEXT:     float _t0;
// CHECK-NEXT:     float _t1;
// CHECK-NEXT:     _t1 = x;
// CHECK-NEXT:     _t0 = x;
...
// CHECK-NEXT:     }
// CHECK-NEXT: }
// CHECK-NEXT: void func8_grad(float x, float y, float *_result, double &_final_error) {
// CHECK-NEXT:     float _t0;
// CHECK-NEXT:     double _delta_z = 0;
// CHECK-NEXT:     double _EERepl_z0;
// CHECK-NEXT:     float _d_z = 0;
